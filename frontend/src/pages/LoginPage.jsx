...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#f9f9fb', fontFamily: 'Inter, system-ui, sans-serif' }}>

      {/* ── Main Content ── */}
      <main className="grow flex items-center justify-center px-5 md:px-16 py-20 relative overflow-hidden">

        {/* Subtle decorative background icon */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden flex justify-center items-center opacity-[0.03]">
          <span className="material-symbols-outlined text-primary" style={{ fontSize: '40rem' }}>
            devices
          </span>
        </div>
        ...
        >
          ...
          <div className="text-center mb-12">
            <h1 className="text-[20px] font-bold text-primary tracking-tight">ShopSphere</h1>
